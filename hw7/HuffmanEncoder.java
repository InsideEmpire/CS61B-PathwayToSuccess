...
public class HuffmanEncoder {
    ...
    public static void main(String[] args) {
        ...
        for (Character ch : lookupTable.keySet()) {
            bitSequenceList.add(lookupTable.get(ch));
        }
        // 9: Assemble all bit sequences into one huge bit sequence.
        BitSequence hugeBitSequence = new BitSequence(BitSequence.assemble(bitSequenceList));
